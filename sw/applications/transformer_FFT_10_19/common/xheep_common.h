...
// ---------------------------------------------------------------------------
// Split configuration: channels [10, 19]
// ---------------------------------------------------------------------------
#define XHEEP_SPLIT_CHANNEL_START    10u
#define XHEEP_SPLIT_CHANNEL_END      20u
#define XHEEP_SPLIT_TOKENS_PER_CH    6u
#define XHEEP_SPLIT_EMIT_CLS         0u

#define XHEEP_SPLIT_OUT_OFFSET_ROWS  (1u + XHEEP_SPLIT_CHANNEL_START * XHEEP_SPLIT_TOKENS_PER_CH)
#define XHEEP_SPLIT_OUT_ROWS         ((XHEEP_SPLIT_CHANNEL_END - XHEEP_SPLIT_CHANNEL_START) * XHEEP_SPLIT_TOKENS_PER_CH)
...
#error "Invalid split channel range for transformer_FFT_10_19"
#endif
