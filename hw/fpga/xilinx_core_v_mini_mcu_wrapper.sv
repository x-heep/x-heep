...
`elsif FPGA_VPK180
  ...
  localparam int unsigned DDR_OBI_NMASTER = 6;
  ...
  // assign ddr_obi_master_req[2] = heep_core_data_req;
  // assign ddr_obi_master_req[3] = heep_core_data_req;
...
`ifdef FPGA_VPK180
      ...
      .ext_core_instr_req_o(ddr_obi_master_req[0]),
      .ext_core_instr_resp_i(ddr_obi_master_resp[0]),

      .ext_core_data_req_o(ddr_obi_master_req[1]),
      .ext_core_data_resp_i(ddr_obi_master_resp[1]),

      .ext_debug_master_req_o(ddr_obi_master_req[2]),
      .ext_debug_master_resp_i(ddr_obi_master_resp[2]),

      .ext_dma_read_req_o(ddr_obi_master_req[3]),
      .ext_dma_read_resp_i(ddr_obi_master_resp[3]),
      
      .ext_dma_write_req_o(ddr_obi_master_req[4]),
      .ext_dma_write_resp_i(ddr_obi_master_resp[4]),
