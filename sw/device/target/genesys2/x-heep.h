...
#pragma message ( "the x-heep.h for GENESYS2 is used" )
...
#ifndef X_HEEP_FPGA_CORE_CLK
#define X_HEEP_FPGA_CORE_CLK 15UL
#endif
#define REFERENCE_CLOCK_Hz (X_HEEP_FPGA_CORE_CLK * 1000UL * 1000UL)
