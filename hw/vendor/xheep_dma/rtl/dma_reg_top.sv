...
module dma_reg_top #(
  ...
  logic window_ifr_qs;
  logic window_ifr_re;
  logic hw_config_mode_qs;
  logic hw_config_mode_wd;
  logic hw_config_mode_we;
  logic [7:0] slot_wait_counter_qs;
  logic [7:0] slot_wait_counter_wd;
  logic slot_wait_counter_we;
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.src_ptr_inc_d1.de),
    .d      (hw2reg.src_ptr_inc_d1.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.src_ptr_inc_d2.de),
    .d      (hw2reg.src_ptr_inc_d2.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.dst_ptr_inc_d1.de),
    .d      (hw2reg.dst_ptr_inc_d1.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.dst_ptr_inc_d2.de),
    .d      (hw2reg.dst_ptr_inc_d2.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.slot.rx_trigger_slot.de),
    .d      (hw2reg.slot.rx_trigger_slot.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.slot.tx_trigger_slot.de),
    .d      (hw2reg.slot.tx_trigger_slot.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.src_data_type.de),
    .d      (hw2reg.src_data_type.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.dst_data_type.de),
    .d      (hw2reg.dst_data_type.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.hw_fifo_en.de),
    .d      (hw2reg.hw_fifo_en.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.dim_config.de),
    .d      (hw2reg.dim_config.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.pad_bottom.de),
    .d      (hw2reg.pad_bottom.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.pad_right.de),
    .d      (hw2reg.pad_right.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.window_size.de),
    .d      (hw2reg.window_size.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.interrupt_en.transaction_done.de),
    .d      (hw2reg.interrupt_en.transaction_done.d ),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.interrupt_en.window_done.de),
    .d      (hw2reg.interrupt_en.window_done.d ),
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (hw_config_mode_we),
    .wd     (hw_config_mode_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.hw_config_mode.q ),

    // to register interface (read)
    .qs     (hw_config_mode_qs)
  );


  // R[slot_wait_counter]: V(False)
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (slot_wait_counter_we),
    .wd     (slot_wait_counter_wd),

    // from internal hardware
    .de     (hw2reg.slot_wait_counter.de),
    .d      (hw2reg.slot_wait_counter.d ),

    // to internal hardware
    .qe     (),
    .q      (reg2hw.slot_wait_counter.q ),

    // to register interface (read)
    .qs     (slot_wait_counter_qs)
  );
  ...
  always_comb begin
    ...
    addr_hit[27] = (reg_addr == DMA_HW_CONFIG_MODE_OFFSET);
    addr_hit[28] = (reg_addr == DMA_SLOT_WAIT_COUNTER_OFFSET);
  end
  ...
  assign hw_config_mode_we = addr_hit[27] & reg_we & !reg_error;
  assign hw_config_mode_wd = reg_wdata[0];

  assign slot_wait_counter_we = addr_hit[28] & reg_we & !reg_error;
  assign slot_wait_counter_wd = reg_wdata[7:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[27]: begin
        reg_rdata_next[0] = hw_config_mode_qs;
      end

      addr_hit[28]: begin
        reg_rdata_next[7:0] = slot_wait_counter_qs;
      end
