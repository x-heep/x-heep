...
module testharness_lattice #( //todo
...
`endif
  ...
  `include "tb_util_lattice.svh" //todo
...
`endif
  ...
  assign clk = clk_i;
  assign rst_n = rst_ni;  assign rst_i = ~rst_ni; //todo
  assign boot_select = boot_select_i;
  assign execute_from_flash = execute_from_flash_i;
  assign exit_valid_o = exit_valid;

//todo added to connect to wrapper
  wire logic rst_led_o, clk_led_o;
  wire [13:0] gpio_13_0;
  assign gpio_13_0  = gpio[13:0];
  wire [3:0] gpio_29_26;
  assign gpio_29_26 = gpio[29:26];
  wire [1:0] gpio_24_23;
...
// X-HEEP wrapper for fpga
  fpga_core_v_mini_mcu_wrapper fpga_core_v_mini_mcu_wrapper_i (
	...
	.spi2_sd_io(gpio_29_26),
	.spi2_csb_o(gpio_24_23),
	.spi2_sck_o(gpio[25]),
