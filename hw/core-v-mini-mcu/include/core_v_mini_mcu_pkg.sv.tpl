...
package core_v_mini_mcu_pkg;
  ...
  localparam logic[31:0] DEBUG_START_ADDRESS = 32'h${hex(address_map.get_region("debug").get_start_address())[2:]};
  localparam logic[31:0] DEBUG_SIZE = 32'h${hex(address_map.get_region("debug").get_length())[2:]};
  localparam logic[31:0] DEBUG_END_ADDRESS = DEBUG_START_ADDRESS + DEBUG_SIZE;
  localparam logic[31:0] DEBUG_IDX = 32'd${memory_ss.ram_numbanks() + 1};

  localparam logic[31:0] AO_PERIPHERAL_START_ADDRESS = 32'h${hex(address_map.get_region("base_peripheral_domain").get_start_address())[2:]};
  localparam logic[31:0] AO_PERIPHERAL_SIZE = 32'h${hex(address_map.get_region("base_peripheral_domain").get_length())[2:]};
  ...
  localparam logic[31:0] PERIPHERAL_START_ADDRESS = 32'h${hex(address_map.get_region("user_peripheral_domain").get_start_address())[2:]};
  localparam logic[31:0] PERIPHERAL_SIZE = 32'h${hex(address_map.get_region("user_peripheral_domain").get_length())[2:]};
  localparam logic[31:0] PERIPHERAL_END_ADDRESS = PERIPHERAL_START_ADDRESS + PERIPHERAL_SIZE;
  localparam logic[31:0] PERIPHERAL_IDX = 32'd${memory_ss.ram_numbanks() + 3};

  localparam logic[31:0] FLASH_MEM_START_ADDRESS = 32'h${hex(address_map.get_region("flash_mem").get_start_address())[2:]};
  localparam logic[31:0] FLASH_MEM_SIZE = 32'h${hex(address_map.get_region("flash_mem").get_length())[2:]};
  ...
  % if user_peripheral_domain.contains_peripheral('serial_link_reg'):
    localparam logic[31:0] SERIAL_LINK_START_ADDRESS = 32'h${hex(address_map.get_region("serial_link").get_start_address())[2:]};
    localparam logic[31:0] SERIAL_LINK_SIZE = 32'h${hex(address_map.get_region("serial_link").get_length())[2:]};
  ...
  // --------------------------
  localparam logic [31:0] EXT_SLAVE_START_ADDRESS = 32'h${address_map.get_region("ext_slaves").get_start_address()};
  localparam logic [31:0] EXT_SLAVE_SIZE = 32'h${address_map.get_region("ext_slaves").get_length()};
