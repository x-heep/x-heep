...
uint32_t __attribute__((section(".xheep_data_flash_only"))) __attribute__ ((aligned (16)))
flash_source_pattern[NUM_WORDS] = {0};

/**
 * SRAM data
 */

uint32_t data_sram[NUM_WORDS] = {
