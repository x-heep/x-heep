...
#include "Vtestharness_lattice.h"
#include "Vtestharness_lattice__Syms.h"
...
void runCycles(unsigned int ncycles, Vtestharness_lattice *dut, VerilatedFstC *m_trace){
...
int main (int argc, char * argv[])
{
  ...
  Vtestharness_lattice *dut = new Vtestharness_lattice;
  ...
  svSetScope(svGetScopeFromName("TOP.testharness_lattice"));
