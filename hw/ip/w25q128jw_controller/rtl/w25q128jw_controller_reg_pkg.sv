...
package w25q128jw_controller_reg_pkg;
  ...
  typedef struct packed {
    logic        q;
  } w25q128jw_controller_reg2hw_status_reg_t;

  typedef struct packed {
    logic [31:0] q;
  } w25q128jw_controller_reg2hw_f_address_reg_t;

  typedef struct packed {
    logic [31:0] q;
  } w25q128jw_controller_reg2hw_s_address_reg_t;

  typedef struct packed {
    logic [31:0] q;
  } w25q128jw_controller_reg2hw_md_address_reg_t;

  typedef struct packed {
    logic [31:0] q;
  } w25q128jw_controller_reg2hw_length_reg_t;

  typedef struct packed {
    logic        q;
  } w25q128jw_controller_reg2hw_intr_status_reg_t;

  typedef struct packed {
    logic        q;
  } w25q128jw_controller_reg2hw_intr_enable_reg_t;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_CONTROL_OFFSET = 6'h 0;
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_STATUS_OFFSET = 6'h 4;
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_F_ADDRESS_OFFSET = 6'h 8;
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_S_ADDRESS_OFFSET = 6'h c;
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_MD_ADDRESS_OFFSET = 6'h 10;
  parameter logic [BlockAw-1:0] W25Q128JW_CONTROLLER_LENGTH_OFFSET = 6'h 14;
  ...
  parameter logic [3:0] W25Q128JW_CONTROLLER_PERMIT [9] = '{
    ...
    4'b 1111, // index[3] W25Q128JW_CONTROLLER_S_ADDRESS
    4'b 1111, // index[4] W25Q128JW_CONTROLLER_MD_ADDRESS
