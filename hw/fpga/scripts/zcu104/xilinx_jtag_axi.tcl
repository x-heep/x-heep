...
################################################################
# This is a generated script based on design: axi_jtag_bridge
#
...
# source axi_jtag_bridge_script.tcl
...
set design_name axi_jtag_bridge
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_jtag_0/s_axi]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_net -net axi_jtag_0_tck  [get_bd_pins axi_jtag_0/tck] \
  [get_bd_ports tck_0]
  connect_bd_net -net axi_jtag_0_tdi  [get_bd_pins axi_jtag_0/tdi] \
  [get_bd_ports tdi_0]
  connect_bd_net -net axi_jtag_0_tms  [get_bd_pins axi_jtag_0/tms] \
  [get_bd_ports tms_0]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn  [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] \
  [get_bd_pins axi_jtag_0/s_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net tdo_0_1  [get_bd_ports tdo_0] \
  [get_bd_pins axi_jtag_0/tdo]
  ...
  [get_bd_pins axi_jtag_0/s_axi_aclk] \
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_jtag_0/s_axi/reg0] -force
