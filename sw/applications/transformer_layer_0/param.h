...
/* Pull-based P2P input from split FFT producers on slots 1 and 2. */
#define XHEEP_PRELAYER_P2P_SRC_SLOT0 1u
#define XHEEP_PRELAYER_P2P_SRC_SLOT1 2u
#define XHEEP_LAYER_P2P_SRC_SLOT XHEEP_PRELAYER_P2P_SRC_SLOT0
#define XHEEP_LAYER_P2P_USER_IN  XHEEP_PRELAYER_P2P_SRC_SLOT0
