...
module serial_link_xheep_wrapper_fifo #(
  ...
  // ila_fifo_wrapper ila_fifo_i (
  //     .clk_0        (clk_i),
  //     .state        (state),
  //     .push         (push),
  //     .pop          (pop),
  //     .empty        (empty),
  //     .aw_valid     (writer_axi_req_i.aw_valid),
  //     .b_valid      (writer_axi_rsp_o.b_valid),
  //     .b_ready      (writer_axi_req_i.b_ready),
  //     .w_valid      (writer_axi_req_i.w_valid),
  //     .reader_req   (reader_req_i),
  //     .reader_gnt   (reader_gnt_o),
  //     .reader_rvalid(reader_rvalid_o)
  // );
