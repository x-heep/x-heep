...
# Generate random integers from -RANGE to RANGE for A and B
...
write_arr(f, 'm_b_t',   np.transpose(m_b), 'int8_t', SIZE)
...
### 16-bit ###
f = open('matrixMul16.h', 'w')
f.write('#ifndef _MATMUL16_\n')
f.write('#define _MATMUL16_\n')
f.write('// This file is automatically generated\n')
...
write_arr(f, 'm_a',   m_a, 'int16_t', SIZE)
write_arr(f, 'm_b',   m_b, 'int16_t', SIZE)
write_arr(f, 'm_b_t',   np.transpose(m_b), 'int16_t', SIZE)
write_arr(f, 'm_exp', m_exp, 'int32_t', SIZE)
...
### 32-bit ###
f = open('matrixMul32.h', 'w')
f.write('#ifndef _MATMUL32_\n')
f.write('#define _MATMUL32_\n')
f.write('// This file is automatically generated\n')
...
write_arr(f, 'm_a',   m_a, 'int32_t', SIZE)
write_arr(f, 'm_b',   m_b, 'int32_t', SIZE)
write_arr(f, 'm_exp', m_exp, 'int32_t', SIZE)
