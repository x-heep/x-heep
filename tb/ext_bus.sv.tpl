...
module ext_bus #(
    ...
    output obi_rsp_t heep_core_instr_resp_o,

    input  obi_req_t heep_core_data_req_i,
    output obi_rsp_t heep_core_data_resp_o,

    input  obi_req_t heep_debug_master_req_i,
    output obi_rsp_t heep_debug_master_resp_o,

    input  obi_req_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_read_req_i,
    output obi_rsp_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_read_resp_o,

    input  obi_req_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_write_req_i,
    output obi_rsp_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_write_resp_o,

    input  obi_req_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_addr_req_i,
    output obi_rsp_t [core_v_mini_mcu_pkg::DMA_NUM_MASTER_PORTS-1:0] heep_dma_addr_resp_o,

    // External master ports
    input  obi_req_t [EXT_XBAR_NMASTER_RND-1:0] ext_master_req_i,
    output obi_rsp_t [EXT_XBAR_NMASTER_RND-1:0] ext_master_resp_o,

    // X-HEEP slave ports (one per external master)
    output obi_req_t [EXT_XBAR_NMASTER_RND-1:0] heep_slave_req_o,
    input  obi_rsp_t [EXT_XBAR_NMASTER_RND-1:0] heep_slave_resp_i,

    // External slave ports
    output obi_req_t [EXT_XBAR_NSLAVE_RND-1:0] ext_slave_req_o,
    input  obi_rsp_t [EXT_XBAR_NSLAVE_RND-1:0] ext_slave_resp_i
);
  ...
  obi_rsp_t [EXT_XBAR_NMASTER-1:0][1:0] demux_xbar_resp;

  // Dummy external master port (to prevent unused warning)
  obi_req_t [EXT_XBAR_NMASTER_RND-1:0] ext_master_req_unused;
  obi_rsp_t [EXT_XBAR_NMASTER_RND-1:0] heep_slave_resp_unused;
  obi_rsp_t [EXT_XBAR_NSLAVE_RND-1:0] ext_slave_resp_unused;
