...
#define DEBUG_START_ADDRESS ${hex(address_map.get_region("debug").get_start_address())}
#define DEBUG_SIZE ${hex(address_map.get_region("debug").get_length())}
#define DEBUG_END_ADDRESS (DEBUG_START_ADDRESS + DEBUG_SIZE)

// base peripherals
#define AO_PERIPHERAL_START_ADDRESS ${hex(address_map.get_region("base_peripheral_domain").get_start_address())}
#define AO_PERIPHERAL_SIZE ${hex(address_map.get_region("base_peripheral_domain").get_length())}
...
// user peripherals
#define PERIPHERAL_START_ADDRESS ${hex(address_map.get_region("user_peripheral_domain").get_start_address())}
#define PERIPHERAL_SIZE ${hex(address_map.get_region("user_peripheral_domain").get_length())}
...
#define EXT_SLAVE_START_ADDRESS ${hex(address_map.get_region("ext_slaves").get_start_address())}
#define EXT_SLAVE_SIZE ${hex(address_map.get_region("ext_slaves").get_length())}
#define EXT_SLAVE_END_ADDRESS (EXT_SLAVE_START_ADDRESS + EXT_SLAVE_SIZE)

#define FLASH_MEM_START_ADDRESS ${hex(address_map.get_region("flash_mem").get_start_address())}
#define FLASH_MEM_SIZE ${hex(address_map.get_region("flash_mem").get_length())}
#define FLASH_MEM_END_ADDRESS (FLASH_MEM_START_ADDRESS + FLASH_MEM_SIZE)

#define SERIAL_LINK_START_ADDRESS ${hex(address_map.get_region("serial_link").get_start_address())}
#define SERIAL_LINK_SIZE ${hex(address_map.get_region("serial_link").get_length())}
