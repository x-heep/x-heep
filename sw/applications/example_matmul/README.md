...
`make app PROJECT=example_matmul COMPILER_PREFIX=riscv-none- ARCH=rv32imc`

This will compile the code using 8-bit input data. While if you want to use 32- or 16-bit input data:

`make app PROJECT=example_matmul COMPILER_PREFIX=riscv-none- ARCH=rv32imc COMPILER_FLAGS="-DMATMUL32"` 
